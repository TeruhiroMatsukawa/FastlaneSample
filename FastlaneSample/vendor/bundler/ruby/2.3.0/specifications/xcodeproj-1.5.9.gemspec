...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<atomos>.freeze, ["~> 0.1.2"])
      s.add_runtime_dependency(%q<CFPropertyList>.freeze, ["< 4.0", ">= 2.3.3"])
      s.add_runtime_dependency(%q<claide>.freeze, ["< 2.0", ">= 1.0.2"])
      s.add_runtime_dependency(%q<colored2>.freeze, ["~> 3.1"])
      s.add_runtime_dependency(%q<nanaimo>.freeze, ["~> 0.2.5"])
    else
      s.add_dependency(%q<atomos>.freeze, ["~> 0.1.2"])
      s.add_dependency(%q<CFPropertyList>.freeze, ["< 4.0", ">= 2.3.3"])
      s.add_dependency(%q<claide>.freeze, ["< 2.0", ">= 1.0.2"])
      s.add_dependency(%q<colored2>.freeze, ["~> 3.1"])
      s.add_dependency(%q<nanaimo>.freeze, ["~> 0.2.5"])
    end
  else
    s.add_dependency(%q<atomos>.freeze, ["~> 0.1.2"])
    s.add_dependency(%q<CFPropertyList>.freeze, ["< 4.0", ">= 2.3.3"])
